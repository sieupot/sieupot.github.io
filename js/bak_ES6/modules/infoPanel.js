export class InfoPanel {
	constructor() {
		...
		this.pgLocationMsg = parseDynamicJsString(this.infoPanel.attr('pgLocationMsg'));
		...
		this.infoPnlContent = `
		    ...
		    <div id="infoPanelMsgsContainerId">
		      ...
		      <div id="welcomeTextId">${this.pgLocationMsg}</div>
		      <div id="chooseLevelTextId">${this.pgDescriptionMsg}</div>
		      <hr>
		    </div>
		  `;
	}
	...
	render = () => {
		this.infoPanel.append(this.infoPnlContent);
	}
}
